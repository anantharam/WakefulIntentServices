...
public abstract class AlarmReceiver extends BroadcastReceiver {
	private static final String WAKEFUL_META_DATA = "com.anantharam.wakeful.intent.services";
	...
	public void onReceive(Context ctxt, Intent intent) {
		...
		if (listener != null) {
			if (intent.getAction() == null) {
				...
				WakefulIntentService.scheduleAlarms(listener, subClass, ctxt, true);
			}
		}
	}
	...
	protected AlarmListener getListener(Context ctxt) {
