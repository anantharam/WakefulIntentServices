...
abstract public class WakefulIntentService extends IntentService {
	...
	static final String NAME = "com.anantharam.wakeful.WakefulIntentServices";
	...
	public static void scheduleAlarms(AlarmListener listener, Class clazz, Context ctxt) {
		scheduleAlarms(listener, clazz, ctxt, true);
	}

	@SuppressWarnings("rawtypes")
	public static void scheduleAlarms(AlarmListener listener, Class clazz, Context ctxt, boolean force) {
		...
		if (lastAlarm == 0 || force
			...
			Intent i = new Intent(ctxt, clazz.getClass());
